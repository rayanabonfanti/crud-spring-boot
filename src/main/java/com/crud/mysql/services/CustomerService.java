package com.crud.mysql.services;

import com.crud.mysql.exceptions.ServicesRuntimeException;
import com.crud.mysql.models.Customer;
import com.crud.mysql.models.CustomerDTO;
import com.crud.mysql.models.CustomerTemp;
import com.crud.mysql.repositorys.CustomerRepository;
...
public class CustomerService {
    ...
    public LinkedHashMap getAllCustomers() {
        ...
        try{
            List<CustomerTemp> getAll = customerRepository.findGetAll();
    ...
    public LinkedHashMap getCustomerByUserName(String customerUserName){
        ...
        CustomerTemp customerTemp = null;
        try{
